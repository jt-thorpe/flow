...
class Ui_login_main_window(object):
    def setupUi(self, login_main_window):
        ...
        self.infinity_logo.setPixmap(QtGui.QPixmap(":/resources/img/infinity_256x256.png"))
        ...
        self.email_icon.setPixmap(QtGui.QPixmap(":/resources/img/mail_32x32.png"))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/resources/img/hidden_32x32.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.lock_icon.setPixmap(QtGui.QPixmap(":/resources/img/lock_32x32.png"))
        ...
        self.hide_password_button = QtWidgets.QPushButton(parent=self.password_frame)
    ...
    def retranslateUi(self, login_main_window):
        ...
        login_main_window.setWindowTitle(_translate("login_main_window", "MainWindow"))
        self.email_input.setPlaceholderText(_translate("login_main_window", "Enter your email"))
        self.password_input.setPlaceholderText(_translate("login_main_window", "Enter your password"))
